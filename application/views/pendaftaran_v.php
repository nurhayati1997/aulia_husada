            ...
            <div class="card-header bg-gradient-info">
              <div class="pt-4 text-center">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <button type="button" class="btn btn-block btn-warning" data-toggle="modal" data-target="#modal-form">Pasien Baru</button>
                            ...
                            <div class="card bg-secondary border-0 mb-0">
                              <div class="card-header bg-primary pb-2">
                                <div class="text-muted text-center text-white">
                                  <small>Data Lengkap Pasien</small>
                                </div>
                              </div>
                              <div class="card-body px-lg-5 py-lg-5">
                                <form role="form">
                                  ...
                                  <div class="text-center">
                                    <button type="button" class="btn btn-primary my-4">Tambahkan</button>
                                  </div>
                                </form>
                              </div>
                            </div>
